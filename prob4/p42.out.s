...
000000000001019c <main>:
   ...
   1019e:	00001297          	auipc	t0,0x1
   101a2:	2fa28293          	addi	t0,t0,762 # 11498 <__fini_array_end>
   101a6:	4301                	li	t1,0
   101a8:	4f01                	li	t5,0
   101aa:	4ea9                	li	t4,10

00000000000101ac <loop>:
   101ac:	00028e03          	lb	t3,0(t0)
   101b0:	9f72                	add	t5,t5,t3
   101b2:	0285                	addi	t0,t0,1
   101b4:	0305                	addi	t1,t1,1
   101b6:	ffd31be3          	bne	t1,t4,101ac <loop>
...
00000000000101c6 <exit>:
   ...
   101d6:	bf87b503          	ld	a0,-1032(a5) # 11bf8 <_global_impure_ptr>
...
000000000001033a <__register_exitproc>:
   ...
   1033c:	bf87b703          	ld	a4,-1032(a5) # 11bf8 <_global_impure_ptr>
   10340:	832a                	mv	t1,a0
...
00000000000103a0 <__call_exitprocs>:
   ...
   103a6:	bf87b983          	ld	s3,-1032(a5) # 11bf8 <_global_impure_ptr>
...
000000000001047c <__errno>:
   1047c:	8101b503          	ld	a0,-2032(gp) # 11c00 <_impure_ptr>
   10480:	8082                	ret
...
0000000000011498 <num>:
   11498:	0201                	addi	tp,tp,0
   1149a:	06050403          	lb	s0,96(a0)
   1149e:	0a090807          	0xa090807
   114a2:	0000                	unimp
   114a4:	0000                	unimp
	...
