...
00000000000100b0 <_start>:
   ...
   100b4:	35818193          	addi	gp,gp,856 # 12408 <__global_pointer$>
   100b8:	81818513          	addi	a0,gp,-2024 # 11c20 <_edata>
   100bc:	85018613          	addi	a2,gp,-1968 # 11c58 <_end>
...
00000000000100e8 <deregister_tm_clones>:
   ...
   100ec:	c0850713          	addi	a4,a0,-1016 # 11c08 <__TMC_END__>
   100f0:	c0878793          	addi	a5,a5,-1016 # 11c08 <__TMC_END__>
   ...
   10104:	c0850513          	addi	a0,a0,-1016
   10108:	8302                	jr	t1
   1010a:	8082                	ret
...
000000000001010c <register_tm_clones>:
   ...
   10110:	c0878593          	addi	a1,a5,-1016 # 11c08 <__TMC_END__>
   10114:	c0850793          	addi	a5,a0,-1016 # 11c08 <__TMC_END__>
   ...
   10130:	c0850513          	addi	a0,a0,-1016
   10134:	8302                	jr	t1
   10136:	8082                	ret

0000000000010138 <__do_global_dtors_aux>:
   10138:	8181c703          	lbu	a4,-2024(gp) # 11c20 <_edata>
   ...
   10162:	4785                	li	a5,1
   10164:	80f18c23          	sb	a5,-2024(gp) # 11c20 <_edata>
...
0000000000010172 <frame_dummy>:
   ...
   10182:	c2858593          	addi	a1,a1,-984 # 11c28 <object.5217>
...
000000000001019c <main>:
   1019c:	e006                	sd	ra,0(sp)
   1019e:	00001517          	auipc	a0,0x1
   101a2:	30a50513          	addi	a0,a0,778 # 114a8 <__fini_array_end>
   101a6:	4599                	li	a1,6
   101a8:	4681                	li	a3,0
   101aa:	00a004ef          	jal	s1,101b4 <sum>
   101ae:	4e19                	li	t3,6
   101b0:	03c6c733          	div	a4,a3,t3

00000000000101b4 <sum>:
   101b4:	00052e03          	lw	t3,0(a0)
   101b8:	96f2                	add	a3,a3,t3
   101ba:	0511                	addi	a0,a0,4
   101bc:	15fd                	addi	a1,a1,-1
   101be:	fe059be3          	bnez	a1,101b4 <sum>
   101c2:	00048067          	jr	s1
...
00000000000101d2 <exit>:
   ...
   101e2:	c107b503          	ld	a0,-1008(a5) # 11c10 <_global_impure_ptr>
...
0000000000010346 <__register_exitproc>:
   ...
   10348:	c107b703          	ld	a4,-1008(a5) # 11c10 <_global_impure_ptr>
   1034c:	832a                	mv	t1,a0
...
00000000000103ac <__call_exitprocs>:
   ...
   103b2:	c107b983          	ld	s3,-1008(a5) # 11c10 <_global_impure_ptr>
...
0000000000010488 <__errno>:
   10488:	8101b503          	ld	a0,-2032(gp) # 11c18 <_impure_ptr>
   1048c:	8082                	ret
...
00000000000114a8 <arr>:
   114a8:	0001                	nop
   114aa:	0000                	unimp
   114ac:	0002                	c.slli	zero,0x0
   114ae:	0000                	unimp
   114b0:	00000003          	lb	zero,0(zero) # 0 <_start-0x100b0>
   114b4:	0004                	0x4
   114b6:	0000                	unimp
   114b8:	0005                	c.nop	1
   114ba:	0000                	unimp
   114bc:	0006                	c.slli	zero,0x1
	...

00000000000114c0 <impure_data>:
	...
   114c8:	19f8                	addi	a4,sp,252
   114ca:	0001                	nop
   114cc:	0000                	unimp
   114ce:	0000                	unimp
   114d0:	1aa8                	addi	a0,sp,376
   114d2:	0001                	nop
   114d4:	0000                	unimp
   114d6:	0000                	unimp
   114d8:	1b58                	addi	a4,sp,436
   114da:	0001                	nop
	...
   115a8:	0001                	nop
   115aa:	0000                	unimp
   115ac:	0000                	unimp
   115ae:	0000                	unimp
   115b0:	330e                	fld	ft6,224(sp)
   115b2:	abcd                	j	11ba4 <impure_data+0x6e4>
   115b4:	1234                	addi	a3,sp,296
   115b6:	e66d                	bnez	a2,116a0 <impure_data+0x1e0>
   115b8:	deec                	sw	a1,124(a3)
   115ba:	0005                	c.nop	1
   115bc:	0000000b          	0xb
	...
...
0000000000011c08 <__TMC_END__>:
	...

0000000000011c10 <_global_impure_ptr>:
   11c10:	14c0                	addi	s0,sp,612
   11c12:	0001                	nop
   11c14:	0000                	unimp
	...

0000000000011c18 <_impure_ptr>:
   11c18:	14c0                	addi	s0,sp,612
   11c1a:	0001                	nop
   11c1c:	0000                	unimp
	...
...
0000000000011c20 <__bss_start>:
	...

0000000000011c28 <object.5217>:
	...
